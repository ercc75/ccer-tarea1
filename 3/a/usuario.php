...
<body>
    ...
    <div class="container" style="padding-top: 80px; padding-bottom: 30px; height: 90vh; overflow-y: auto">
        <h3 style="font-weight: bold">Formulario de recogida y validación de datos</h3>
        <br />
        <div class="container bg-white p-4" style="width:560px; border: 20px solid #198754">
            ...
            <?php
                ...
                if (empty($coment)) {
                    $errores[]="No ha introducido la consulta. Vuelva a la página de introducción de datos.";
                }
                ...
                if (isset($errores)) { //Si se crea el array $errores es porque ha habido algún error y el bucle foreach imprime los errores
                    ...
                    echo nl2br("El nombre y apellidos es " . $resultados_nombre[0] . "\n");
                    echo nl2br("El correo es " . $valor_correo . "\n");
                    if (!empty($telefono_sanitized)) {
                        echo nl2br("El teléfono es " . $resultados_telefono[0] . "\n");
                    } else {
                        echo nl2br("No ha introducido datos de teléfono\n");
                    }
                    if (!empty($web_sanitized)) {
                        echo nl2br("El sitio web es " . $valor_web . "\n");
                    } else {
                        echo nl2br("No ha introducido datos de sitio web\n");
                    }
                    echo nl2br("La consulta  es \"" . $coment . "\"\n\n");
                }
            ?>
            
            <p style="text-align: right"><a href="3a.html">Volver a introducir datos</a></p>
        </div>
    </div>

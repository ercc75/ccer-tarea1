...
<body>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink4">
                                <li><a class="dropdown-item" href="../../4/a/4a.html">Juego de piedra, papel, tijera,
                                        lagarto o
                                        Spock</a></li>
                                <li><a class="dropdown-item" href="4b.html">Cálculo del área y longitud de una
                                        circunferencia</a></li>
                                <li>
    ...
    <div class="container" style="padding-top: 80px; padding-bottom: 30px; height: 90vh; overflow-y: auto">
        <h3 style="font-weight: bold">Cálculo del área y longitud de una circunferencia</h3>
        <br />
        <div class="container bg-white p-4" style="width:560px; border: 20px solid #198754">
            <h3>Área y longitud de circunferencia</h3><br />
            ...
            <?php
                ...
                if (empty($radCirc)) {
                    $errores[]="No has introducido un número. Vuelve a la página de introducción de datos.";
                } elseif (!$valor) {
                    $errores[]="El dato introducido no es correcto. Vuelve a la página de introducción de datos.";
                }
                ...
                if (isset($errores)) { //Si se crea el array $errores es porque ha habido algún error y el bucle foreach imprime los errores
                    ...
                    echo nl2br("El área de la circunferencia de radio " . $resultados[0] . " es " . $area . " unidades²\n");
